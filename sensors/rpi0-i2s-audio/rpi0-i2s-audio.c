...
static struct asoc_simple_card_info snd_rpi_simple_card_info = {
	.card = "snd_rpi0_simple_card", // -> snd_soc_card.name
...
module_init(snd_i2s_rpi0_init);
module_exit(snd_i2s_rpi0_exit);
